...
const Recruiters = () => {
  ...
  return (
    ...
    <div className='bg-dark p-20'>  
        <Scroll/> 
      <Navbar />
      <h1 data-aos="fade-down" className='text-3xl md:text-6xl font-bold text-white mt-3 mb-10 text-center'>Our Recruiters</h1>
      <div data-aos="fade-up" className='mx-24 mb-10 bg-white rounded-3xl shadow-lg p-5'>
